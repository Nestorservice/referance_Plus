...
export default {
    ...
    Deposits_Report: 'Rapport des specials ventes',
    Expense_Report: 'Rapport des dépenses',
    Deposit_Category: 'Catégorie de vente',
    Total_Deposits: 'Total des ventes via ferme',
    ...
    file: 'Fichier',
    Accounting: 'Ma Ferme',
    deposit_delete: 'Supprimer la vente',
    deposit_edit: 'Modifier la vente',
    deposit_add: 'Ajouter une vente',
    deposit_view: 'Voir la vente',
    expense_add: 'Ajouter une Dépense',
    expense_edit: 'Modifier une Dépense',
    expense_delete: 'Supprimer une Dépense',
    List_Deposit: 'Liste des ventes',
    Create_deposit: 'Créer une vente',
    deposit_Category: 'Catégorie de Vente',
