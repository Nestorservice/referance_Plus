...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Enregistrement de l'Observer pour les alertes de stock (OceanTechnologie)
        \App\Models\product_warehouse::observe(\App\Observers\ProductWarehouseObserver::class);
         /*ADD THIS LINES*/
        $this->commands([
